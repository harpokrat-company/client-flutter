...
class FGrecaptcha {
    static const MethodChannel channel = const MethodChannel('com.harpokrat.android/autofill');
    ...
    static Future<bool> get isAvailable async {
        ...
        var awailable = await channel.invokeMethod("isSupported");
    ...
    static Future<String> verifyWithRecaptcha(String siteKey) async {
        ...
        return await channel.invokeMethod("verify", {"key": siteKey});
    }
}
